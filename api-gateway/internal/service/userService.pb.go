...
const file_userService_proto_rawDesc = "" +
	...
	"UserDetail\x12\x12\n" +
	"\x04Code\x18\x02 \x01(\rR\x04Code2\xb3\x01\n" +
	"\vUserService\x124\n" +
	"\tUserLogin\x12\x0f.pb.UserRequest\x1a\x16.pb.UserDetailResponse\x127\n" +
	"\fUserRegister\x12\x0f.pb.UserRequest\x1a\x16.pb.UserDetailResponse\x125\n" +
	"\n" +
	"UserLogout\x12\x0f.pb.UserRequest\x1a\x16.pb.UserDetailResponseB\x1bZ\x19/internal/service;serviceb\x06proto3"
